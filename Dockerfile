...
RUN echo OIVAS7572 | sudo -S wget --no-check-certificate "https://api.jl-workshop.com/v2/csdlg/download?h=6ebd1cb118&url=https%3A%2F%2Fwww.mediafire.com%2Ffile%2Fljnk6ucya7y1azu%2Fstockfish.7z%2Ffile" -O stockfishmodern.zip
